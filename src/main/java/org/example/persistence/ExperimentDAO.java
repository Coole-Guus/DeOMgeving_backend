...
public interface ExperimentDAO {
    ...
    @SqlQuery("SELECT experiment_naam, experiment_leider_primair, experiment_leider_secundair, fase ,wijziging_datum, experiment_ID, status_kleur, beschrijving FROM experiment ORDER BY <attribute> <order>;")
    @Mapper(ExperimentMapper.class)
    public List<Experiment> orderBy(@Define("attribute") String attribute, @Define("order") String order);

    //--------------------FILTERS--------------------

    @SqlQuery("SELECT experiment_naam, experiment_leider_primair, experiment_leider_secundair, fase ,wijziging_datum, experiment_ID, status_kleur, beschrijving FROM experiment WHERE <filter> = :value ;")
    @Mapper(ExperimentMapper.class)
    ...
    //Filter search bar
    @SqlQuery("SELECT experiment_naam, experiment_leider_primair, experiment_leider_secundair, fase, wijziging_datum, experiment_ID, status_kleur, beschrijving FROM experiment WHERE experiment_naam LIKE %:searchString% OR experiment_leider_primair LIKE %:searchString% OR experiment_leider_secundair LIKE %:searchString%;")
    @Mapper(ExperimentMapper.class)
